...
namespace DotNetNuke.Modules.SocialUrlProvider
{
    ...
    internal static class UrlController
    {
        ...
        /// <returns></returns>
        private static string MakeItemFriendlyUrl(FriendlyUrlInfo friendlyUrl, SocialUrlProvider provider, FriendlyUrlOptions options)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        internal static Hashtable GetFriendlyUrlIndex(int portalId, SocialUrlProvider provider, FriendlyUrlOptions options)
        {
        ...
        /// <param name="provider"></param>
        /// <returns></returns>
        internal static Hashtable GetQueryStringIndex(int portalId, SocialUrlProvider provider, FriendlyUrlOptions options, bool forceRebuild)
        {
            string qsCacheKey = GetQueryStringIndexCacheKeyForPortal(portalId);
        ...
        /// <param name="provider"></param>
        /// <param name="options"></param>
        private static void RebuildIndexes(int portalId, SocialUrlProvider provider, FriendlyUrlOptions options)
        {
            Hashtable queryStringIndex = null;
            Hashtable friendlyUrlIndex = null;
            string qsCacheKey = GetQueryStringIndexCacheKeyForPortal(portalId);
