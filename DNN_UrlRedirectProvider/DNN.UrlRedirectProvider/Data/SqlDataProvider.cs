...
namespace DNN.Modules.UrlRedirectProvider.Data
{
    internal class SqlDataProvider : DataProvider 
    {
        //TODO : set DB naming prefix values for module.        
        private const string ModuleQualifier = "urp_";
        ...
        internal override IDataReader GetUrlRedirectsForPortal(int portalId)
        {
            string sp = GetFullyQualifiedName("GetRedirectsForPortal");
